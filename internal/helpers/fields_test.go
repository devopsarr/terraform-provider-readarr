...
func TestReadFields(t *testing.T) {
	...
	for name, test := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			expectedFields := make([]*readarr.Field, 1)
			expectedFields[0] = readarr.NewField()
...
func TestWriteFields(t *testing.T) {
	...
	for name, test := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			fields := make([]*readarr.Field, 1)
			fields[0] = readarr.NewField()
