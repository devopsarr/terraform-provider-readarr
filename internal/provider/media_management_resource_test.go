		...
		Steps: []resource.TestStep{
			...
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("readarr_media_management.test", "file_date", "none"),
					resource.TestCheckResourceAttrSet("readarr_media_management.test", "id"),
				),
			},
			// Unauthorized Read
			{
			...
			{
				Config: testAccMediaManagementResourceConfig("bookReleaseDate"),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("readarr_media_management.test", "file_date", "bookReleaseDate"),
				),
			},
			// ImportState testing
			{
				ResourceName:      "readarr_media_management.test",
				ImportState:       true,
...
func testAccMediaManagementResourceConfig(date string) string {
	return fmt.Sprintf(`
	resource "readarr_media_management" "test" {
