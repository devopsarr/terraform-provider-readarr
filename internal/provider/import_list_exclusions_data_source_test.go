		...
		Steps: []resource.TestStep{
			...
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckTypeSetElemNestedAttrs("data.readarr_import_list_exclusions.test", "import_list_exclusions.*", map[string]string{"foreign_id": "53b106e7-0cc6-42cc-ac95-ed8d30a3a98e"}),
				),
			},
		},
	})
...
data "readarr_import_list_exclusions" "test" {
}
`
