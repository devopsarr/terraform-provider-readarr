		...
		Steps: []resource.TestStep{
			...
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckTypeSetElemNestedAttrs("data.readarr_delay_profiles.test", "delay_profiles.*", map[string]string{"enable_usenet": "true"}),
				),
			},
		},
	})
...
data "readarr_delay_profiles" "test" {
}
`
