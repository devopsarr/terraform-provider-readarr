		...
		Steps: []resource.TestStep{
			...
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("readarr_remote_path_mapping.test", "remote_path", "/test1/"),
					resource.TestCheckResourceAttrSet("readarr_remote_path_mapping.test", "id"),
				),
			},
			// Update and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("readarr_remote_path_mapping.test", "remote_path", "/test2/"),
				),
			},
			// ImportState testing
			{
				ResourceName:      "readarr_remote_path_mapping.test",
				ImportState:       true,
