		...
		Steps: []resource.TestStep{
			...
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckTypeSetElemNestedAttrs("data.readarr_custom_formats.test", "custom_formats.*", map[string]string{"include_custom_format_when_renaming": "true"}),
				),
			},
		},
	})
...
data "readarr_custom_formats" "test" {
}
`
