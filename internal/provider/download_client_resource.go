...
func (d *DownloadClient) write(ctx context.Context, downloadClient *readarr.DownloadClientOutput) {
...
func (d *DownloadClient) read(ctx context.Context) *readarr.DownloadClientInput {
	var tags []int
