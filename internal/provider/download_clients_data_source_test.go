		...
		Steps: []resource.TestStep{
			...
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckTypeSetElemNestedAttrs("data.readarr_download_clients.test", "download_clients.*", map[string]string{"port": "9091"}),
				),
			},
		},
	})
...
data "readarr_download_clients" "test" {
}
`
