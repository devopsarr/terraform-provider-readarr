		...
		Steps: []resource.TestStep{
			...
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckTypeSetElemNestedAttrs("data.readarr_release_profiles.test", "release_profiles.*", map[string]string{"required.0": "sd"}),
				),
			},
		},
	})
...
data "readarr_release_profiles" "test" {
}
`
