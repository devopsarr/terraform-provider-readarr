		...
		Steps: []resource.TestStep{
			...
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("readarr_indexer_nyaa.test", "base_url", "https://nyaa.org"),
					resource.TestCheckResourceAttrSet("readarr_indexer_nyaa.test", "id"),
				),
			},
			// Unauthorized Create
			{
			...
			// Update and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("readarr_indexer_nyaa.test", "base_url", "https://nyaa.net"),
				),
			},
			// ImportState testing
			{
				ResourceName:      "readarr_indexer_nyaa.test",
				ImportState:       true,
...
func testAccIndexerNyaaResourceConfig(name, url string) string {
	return fmt.Sprintf(`
	resource "readarr_indexer_nyaa" "test" {
