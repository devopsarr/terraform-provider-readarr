		...
		Steps: []resource.TestStep{
			...
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("readarr_custom_format.test", "include_custom_format_when_renaming", "false"),
					resource.TestCheckResourceAttrSet("readarr_custom_format.test", "id"),
				),
			},
			// Unauthorized Read
			{
			...
			// Update and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("readarr_custom_format.test", "include_custom_format_when_renaming", "true"),
				),
			},
			// ImportState testing
			{
				ResourceName:      "readarr_custom_format.test",
				ImportState:       true,
